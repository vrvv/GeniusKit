...
import com.mssoftwareindia.geniuskit.databinding.ActivityAddShopBinding;
...
public class AddShopActivity extends AppCompatActivity {
    public AddShopActivity context;
    public String TAG = "AddShopActivity";
    View view;
    public ActivityAddShopBinding binding;
    ...
    private void doAddShop() {
        ...
        Call<ResponseBody> call = APIClient.getInstance().addShop(Name, personName, email, mobile, satateId, cityId,
                pincode, address, MyApp.userModel.getData().getResponse().get(0).getRegcode(), aadhar, longitude+"", latitude+"");
