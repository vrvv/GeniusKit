...
public class SearchShopAdapter extends
    ...
    public SearchShopAdapter(Context mContext, ArrayList<ShopListResponse.Response> mArrayList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new HolderHorizontal(mInflater.inflate(R.layout.view_search_shop, parent, false));
    ...
    class HolderHorizontal extends RecyclerView.ViewHolder {
        TextView tv_branch_name, tv_number, tv_address, tv_contact_person, tv_add, tvAdded;
