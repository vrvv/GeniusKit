...
public class ShopListResponse implements Serializable {
    ...
    public static class Response implements Serializable {
        ...
        public String shop_mobile_number = "";
        @Expose
        ...
        public String getShop_contact_person() {
            return shop_contact_person;
        }

        public void setShop_contact_person(String shop_contact_person) {
            this.shop_contact_person = shop_contact_person;
        }

        public String getShop_mobile_number() {
            return shop_mobile_number;
        }

        public void setShop_mobile_number(String shop_mobile_number) {
            this.shop_mobile_number = shop_mobile_number;
        }
